...
class DemandAggregator:
    ...
    def aggregate_spatially(self):
        ...
        xml_det_ids = set(self.detector_intervals.keys())
        csv_det_ids = set(self.detector_mapping.keys())
        
        matched = xml_det_ids & csv_det_ids
        xml_only = xml_det_ids - csv_det_ids
        csv_only = csv_det_ids - xml_det_ids
