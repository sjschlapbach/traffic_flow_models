...
- Set up initial version of release pipeline
- Update action to skip versioning check for the moment
- Update github action to make commit with changelog changes
- Update release workflow to exclude changelog version check
- Update changelog with diff for version refs/heads/release-test
